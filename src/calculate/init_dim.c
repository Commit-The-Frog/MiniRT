...
/*   Updated: 2024/05/22 22:48:06 by junkim2          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minirt.h"

void	shoot_ray(t_dim *dim)
{
	double	gx;
	double	gy;
	t_vec	dx;
...
{
	get_cam_dir(dim);
	// coord_print(*dim->cam_coord);
	// vector_print(*dim->cam_xv);
	// vector_print(*dim->cam_yv);
	// vector_print(*dim->cam_zv);
	shoot_ray(dim);
}
