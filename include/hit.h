...
t_hit			hit_coord_cal_sp(t_vec ray, t_coord cam, t_obj *obj, \
				t_hit *hit);
t_hit			hit_pl(t_vec ray, t_coord cam, t_obj *obj, t_hit *hit);
t_hit			hit_coord_cal_pl(t_vec ray, t_coord cam, t_obj *obj, \
				t_hit *hit);
...
t_hit			hit_coord_cal_cy(t_vec ray, t_coord cam, t_obj *obj, \
				t_hit *hit);
